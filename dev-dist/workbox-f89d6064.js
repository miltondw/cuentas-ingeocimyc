define(["exports"], function (exports) {
  ...
  class RegExpRoute extends Route {
     ...
     * [capture groups]{@link https://developer.mozilla.org/es-CO/docs/Web/JavaScript/Reference/Global_Objects/RegExp#grouping-back-references},
  ...
  class StrategyHandler {
    ...
    async cachePut(key, response) {
      ...
      try {
        ...
        if (error instanceof Error) {
          // See https://developer.mozilla.org/es-CO/docs/Web/API/DOMException#exception-QuotaExceededError
  ...
  class Strategy {
     ...
     * [`init`](https://developer.mozilla.org/es-CO/docs/Web/API/WindowOrWorkerGlobalScope/fetch#Parameters)
    ...
    constructor(options = {}) {
       ...
       * [`init`]{@link https://developer.mozilla.org/es-CO/docs/Web/API/WindowOrWorkerGlobalScope/fetch#Parameters}
   ...
   * [`ResponseInit`]{@link https://developer.mozilla.org/es-CO/docs/Web/API/Response/Response#Syntax}
  ...
  class PrecacheStrategy extends Strategy {
     ...
     * to use in conjunction with this caching strategy.
     * @param {Object} [options.fetchOptions] Values passed along to the
     * {@link https://developer.mozilla.org/es-CO/docs/Web/API/WindowOrWorkerGlobalScope/fetch#Parameters|init}
     * of all fetch() requests made by this strategy.
     * @param {Object} [options.matchOptions] The
  ...
  class PrecacheController {
     ...
     * [`cache.match()`](https://developer.mozilla.org/es-CO/docs/Web/API/Cache/match)
   ...
   * respond to
   * [network requests]{@link https://developer.mozilla.org/es-CO/docs/Web/API/Service_Worker_API/Using_Service_Workers#Custom_responses_to_requests}
  ...
  class NavigationRoute extends Route {
     ...
     * [`pathname`]{@link https://developer.mozilla.org/es-CO/docs/Web/API/HTMLHyperlinkElementUtils/pathname}
     * and [`search`]{@link https://developer.mozilla.org/es-CO/docs/Web/API/HTMLHyperlinkElementUtils/search}
